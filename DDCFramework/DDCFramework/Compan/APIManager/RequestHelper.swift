...
class RequestHelper : NSObject {
    ...
    func createRequestForEntity(entity:Entity, newValue: Any, entityGroupId: String,parentEntityGroupId:String,isCalculativeEntity: Bool = false){
        self.getRepeatableEntityAddress(entityData: entity, newValue: newValue, entityGroupId: entityGroupId,parentEntityGroupId:parentEntityGroupId,isCalculativeEntity: isCalculativeEntity)
    ...
    func getRepeatableEntityAddress(entityData:Entity, newValue: Any,entityGroupId: String,parentEntityGroupId:String,isCalculativeEntity: Bool) {
...
//                        print("Got entity at main Entity at index:",entityIndex.description)
                            ...
                            if parentEntityGroupId != "99" {
                                if entityGroup[entityGroupIndex].value.uniqueId == parentEntityGroupId  {
                                    for nestedEntityIndex in 0..<(entityGroup[entityGroupIndex].value.sortedEntitiesArray?.count ?? 0) {
                                        ...
                                        self.repeatableForLoopCheck(entity: entityy, entityIndex: nestedEntityIndex, entityId: entityId,entityData: entityData,newValue: newValue, entityGroupId: entityGroupId,isCalculativeEntity: isCalculativeEntity)
                                }
                            }
                        }
                            } else {
    ...
    func repeatableForLoopCheck( entity: Entity,entityIndex: Int,entityId: String,entityData: Entity, newValue: Any,entityGroupId: String,isCalculativeEntity: Bool){
                if entity.type == .entityGroupRepeatable || entity.type == .entityGroup {
                    if let entityGroup = entity.sortedEntityGroupsArray {
                        for entityGroupIndex in 0..<(entityGroup.count ) {
                            if entityGroup[entityGroupIndex].value.uniqueId == entityGroupId {
                                for nesstedEntityIndex in 0..<(entityGroup[entityGroupIndex].value.sortedEntitiesArray?.count ?? 0) {
                                    ...
                                    self.repeatableForLoopCheck(entity: entityy, entityIndex: nesstedEntityIndex, entityId: entityId,entityData: entityData,newValue: newValue, entityGroupId: entityGroupId,isCalculativeEntity: isCalculativeEntity)
                            }
                        }
                    }
                  }
