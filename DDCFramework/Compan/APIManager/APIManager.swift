...
//            urlRequest.setValue("Bearer \(Utilities.getToken())", forHTTPHeaderField: "Authorization")
    ...
    // Completion Handlers
    public typealias completionHandlerWithSuccess = (_ success:Bool) -> Void
    public typealias completionHandlerWithSuccessAndErrorMessage = (_ success:Bool, _ errorMessage: String) -> Void
    public typealias completionHandlerWithSuccessAndMessage = (_ success:Bool,_ message: NSDictionary) -> Void
    public typealias completionHandlerWithResponse = (HTTPURLResponse) -> Void
    public typealias completionHandlerWithResponseAndError = (HTTPURLResponse?, NSError?) -> Void
    public typealias completionHandlerWithSuccessAndResultArray = (_ success:Bool, _ results: NSArray) -> Void
    public typealias completionHandlerWithSuccessAndResultsArray = (_ success:Bool, _ result_1: NSArray, _ result_2: NSArray) -> Void
    public typealias completionHandlerWithStatusCode = (_ success:Bool,_ message: NSDictionary,_ statusCode: Int) -> Void
    public typealias completionHandlerWithBoolAndStatusCode = (_ success:Bool,_ message: Bool,_ statusCode: Int) -> Void

        
    // Login User
    // completion : Completion object to return parameters to the calling functions
    // Returns User details
    public func makeRequestToLoginUser(params:[String:AnyObject],completion: @escaping completionHandlerWithStatusCode) {
    ...
    public func makeRequestToGetTemplate(params:[String:Any],completion: @escaping completionHandlerWithStatusCode) {
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns Dynamic Form Components in Json format
    public func makeRequestToUpdateEntityValue(data:Data,completion: @escaping completionHandlerWithStatusCode) {
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns
    public func makeRequestToAddRepeatableEntityGroup(data:Data,completion: @escaping completionHandlerWithStatusCode) {
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns
    public func makeRequestToDeleteRepeatableEntityGroup(data:Data,completion: @escaping completionHandlerWithStatusCode) {
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns
    public func makeRequestToExecuteDDCScript(jsonString: String,data:Data,completion: @escaping completionHandlerWithBoolAndStatusCode) {
        let json = jsonString
...
//                    APIManager.sharedInstance.showAlertWithMessage(message: self.choooseMessageForErrorCode(errorCode: statusCode!))
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns
    public func makeRequestToExecuteCalculativeDDCScript(jsonString: String,data:Data,completion: @escaping completionHandlerWithBoolAndStatusCode) {
        let json = jsonString
        Alamofire.request(Router.excuteDDCScript(data)).responseJSON { response in
            switch response.result {
            case .success(let JSON):
    ...
    // completion : Completion object to return parameters to the calling functions
    // Returns
    public func makeRequestToSaveTemplateInstance(data:Data,completion: @escaping completionHandlerWithStatusCode) {
    ...
    public func showAlertWithCode(code:Int)  {
    ...
    public func choooseMessageForErrorCode(errorCode: Int) -> String {
        var message: String = ""
        switch errorCode {
